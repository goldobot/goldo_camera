...
OpenCV - build from source:
  ...
  cosmorak@nanorak:~/Programs$ git clone https://github.com/opencv/opencv_contrib
  cosmorak@nanorak:~/Programs/opencv_contrib$ git checkout 4.5.4
  cosmorak@nanorak:~/Programs$ git clone https://github.com/opencv/opencv
...
Test device USB ou CSI avec gstreamer:
