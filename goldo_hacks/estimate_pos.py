...
if len(sys.argv) != 3:
    print ("usage : {} <my_x> <my_y>".format(sys.argv[0]))
    exit()

my_x = int(sys.argv[1])
my_y = int(sys.argv[2])

#print ("my_x = {}".format(my_x))
#print ("my_y = {}".format(my_y))

#for p in P_exp:
#    print ("    ({:>5d}, {:>5d}, {:>5d}, {:>5d}),".format(p[2],p[3],p[0],p[1]))

#for pe in P_exp:
#    for p in pe:
#        print ("    ({:>5d}, {:>5d}, {:>5d}, {:>5d}),".format(p[0],p[1],p[2],p[3]))
#    print ()
...
#        (my_Xr, my_Yr) = P_map[x][y]
#        if (my_Xr!=0) or (my_Yr!=0):
#            print (" <{}, {}> -> <{}, {}>".format(x, y, my_Xr, my_Yr))
